...
# Дополнение: Unit-тестирование

## Описание

Реализовано **unit-тестирование** трех математических функций приложения с использованием **MSTest Framework**.
...
#### FirstFunction (`FirstCalculate`)
- ✅ Корректность вычислений при валидных данных
- ✅ Обработка x = 0
- ✅ Работа с отрицательными x (модуль)
- ✅ Обработка y = 0 (логарифм не определён)

#### SecondFunction (`vich`)
- ✅ Валидация пустых полей
- ✅ Валидация некорректного ввода
- ✅ Проверка работы без выбранной функции
- ✅ Корректность вычисления sh(x)

#### ThirdFunction (`ThirdCalculate`)
- ✅ Корректность вычислений при валидных данных
- ✅ Обработка x = 0
- ✅ Работа с отрицательными значениями
- ✅ Проверка больших значений x
...
Каждый тест содержит XML-документацию с описанием проверяемого сценария:
