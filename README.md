...
![Функция 1](Screenshots/page1.png)
Вычисление **a = ln(y^(−√|x|)) · (x − y/2) + sin²(arctg(z))** с построением графика.


### Функция 2 (Страница 2)

![Функция 2](Screenshots/page2.png)

Табличное вычисление **y = x⁴ + cos(2 + x³ − b)** в диапазоне от x₀ = 4.6 до xₖ = 5.8 с шагом dx = 0.2, b = 1.3.

### Функция 3 (Страница 3)

![Функция 3](Screenshots/page3.png)

Вычисление значения **e** в зависимости от чётности **i** и знака **x**.
...
###  Страница 1 — Функция e(i, x)


![Страница 1](Screenshots/app_page1.png)

---

###  Страница 2 — Табличное вычисление y


![Страница 2](Screenshots/app_page2.png)

---

###  Страница 3 — Вычисление a + График


![Страница 3](Screenshots/app_page3.png)
...
*Практическая работа №4 · Группа 3ИСИП323 · 2024–2025*
